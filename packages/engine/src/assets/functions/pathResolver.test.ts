...
describe('STATIC_ASSET_REGEX', () => {
  it('should match static asset URLs', () => {
    const positiveCases = [
      {
        url: 'https://example.com/projects/xrengine/default-project/assets/images/logo.png',
        orgName: 'xrengine',
        projectName: 'default-project',
        assetPath: 'assets/images/logo.png'
      },
      {
        url: 'https://example.com/static-resources/xrengine/default-project/assets/images/logo.png',
        orgName: 'xrengine',
        projectName: 'default-project',
        assetPath: 'assets/images/logo.png'
      },
      {
        url: 'https://example.com/projects/xrengine/default-project/assets/animations/emotes.glb',
        orgName: 'xrengine',
        projectName: 'default-project',
        assetPath: 'assets/animations/emotes.glb'
      },
      {
        url: 'https://example.com/projects/xrengine/default-project/assets/animations/locomotion.glb',
        orgName: 'xrengine',
        projectName: 'default-project',
