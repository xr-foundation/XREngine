...
import { toTrianglesDrawMode } from '@xrengine/spatial/src/common/classes/BufferGeometryUtils'
...
export class GLTFParser {
  ...
  loadMaterial(materialIndex) {
    ...
    if (!materialExtensions[EXTENSIONS.XRENGINE_MATERIAL] && materialExtensions[EXTENSIONS.KHR_MATERIALS_UNLIT]) {
