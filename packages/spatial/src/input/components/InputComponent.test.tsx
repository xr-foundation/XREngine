...
import { ReactorReconciler, ReactorRoot, getMutableState, getState, startReactor } from '@xrengine/hyperflux'
...
describe('InputExecutionSystemGroup', () => {
  describe('Fields', () => {
    ...
    it('should initialize the InputExecutionSystemGroup.uuid field with the expected value', () => {
      assert.equal(System!.uuid, 'xrengine.engine.InputExecutionSystemGroup')
    })
