...
import { defineState, getMutableState, getState, NO_PROXY, none, State, useMutableState } from '@xrengine/hyperflux'
...
export const RendererComponent = defineComponent({
   ...
   * see https://github.com/xr-foundation/xrengine/issues/9308
   */
  activeRender: false,
...
export const WebGLRendererSystem = defineSystem({
  uuid: 'xrengine.engine.WebGLRendererSystem',
