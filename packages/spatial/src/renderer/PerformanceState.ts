...
import { ComponentType, defineSystem, ECSState, PresentationSystemGroup } from '@xrengine/ecs'
import { profile } from '@xrengine/ecs/src/Timer'
import { defineState, getMutableState, getState, State, useMutableState } from '@xrengine/hyperflux'
import { RendererComponent, RenderSettingsState } from '@xrengine/spatial/src/renderer/WebGLRendererSystem'
...
export const PerformanceSystem = defineSystem({
  uuid: 'xrengine.engine.PerformanceSystem',
