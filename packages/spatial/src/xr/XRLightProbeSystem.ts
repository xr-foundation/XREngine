...
import { getComponent, getMutableComponent, setComponent } from '@xrengine/ecs/src/ComponentFunctions'
...
export const XRLightProbeSystem = defineSystem({
  uuid: 'xrengine.engine.XRLightProbeSystem',
