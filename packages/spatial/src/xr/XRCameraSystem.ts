...
import { defineActionQueue, getMutableState, getState } from '@xrengine/hyperflux'
...
export const XRCameraInputSystem = defineSystem({
  uuid: 'xrengine.engine.XRCameraInputSystem',
...
export const XRCameraUpdateSystem = defineSystem({
  uuid: 'xrengine.engine.XRCameraUpdateSystem',
