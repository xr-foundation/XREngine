...
import { AvatarID, avatarPath } from '@xrengine/common/src/schemas/user/avatar.schema'
import { CommonKnownContentTypes } from '@xrengine/common/src/utils/CommonKnownContentTypes'

import { staticResourcePath, StaticResourceType } from '@xrengine/common/src/schema.type.module'
