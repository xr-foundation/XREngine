...
import { MULTIPART_CHUNK_SIZE, MULTIPART_CUTOFF_SIZE } from '@xrengine/common/src/constants/FileSizeConstants'

import { ASSETS_REGEX, PROJECT_PUBLIC_REGEX, PROJECT_REGEX, PROJECT_THUMBNAIL_REGEX } from '@xrengine/common/src/regex'
...
export class S3Provider implements StorageProviderInterface {
  ...
  async createFunction(functionName: string, routes: string[]) {
    ...
    const params = {
      ...
      FunctionConfig: {
        Comment: 'Function to handle routing of XREngine client',
