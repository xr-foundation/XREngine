...
import { StaticResourceType, staticResourcePath } from '@xrengine/common/src/schemas/media/static-resource.schema'

import { projectHistoryPath, projectPath } from '@xrengine/common/src/schema.type.module'
