...
import { projectGithubPushPath } from '@xrengine/common/src/schemas/projects/project-github-push.schema'
...
describe('project-github-push.test', () => {
  ...
  before(async () => {
    ...
    const fullName = `@xrengine/${projectName}`
