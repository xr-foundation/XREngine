...
import { getOptionalMutableComponent, useComponent } from '@xrengine/ecs/src/ComponentFunctions'
...
import { loadResource } from '@xrengine/engine/src/assets/functions/resourceLoaderFunctions'
import { ModelComponent } from '@xrengine/engine/src/scene/components/ModelComponent'
import { Heuristic, VariantComponent, VariantLevel } from '@xrengine/engine/src/scene/components/VariantComponent'
import { State, getState, useHookstate } from '@xrengine/hyperflux'
import {
  ResourceManager,
  ResourceState,
  ResourceStatus,
