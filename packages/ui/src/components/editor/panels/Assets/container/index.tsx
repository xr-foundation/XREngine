...
import { StaticResourceQuery, StaticResourceType, staticResourcePath } from '@xrengine/common/src/schema.type.module'
import { AssetsPanelCategories } from '@xrengine/editor/src/components/assets/AssetsPanelCategories'
import { AssetSelectionChangePropsType } from '@xrengine/editor/src/components/assets/AssetsPreviewPanel'
import { inputFileWithAddToScene } from '@xrengine/editor/src/functions/assetFunctions'
import { FileIcon } from '@xrengine/editor/src/panels/files/fileicon'
import { FileUploadProgress } from '@xrengine/editor/src/panels/files/loaders'
import DeleteFileModal from '@xrengine/editor/src/panels/files/modals/DeleteFileModal'
import { EditorState } from '@xrengine/editor/src/services/EditorServices'
import { FilesViewModeSettings } from '@xrengine/editor/src/services/FilesState'
import { ClickPlacementState } from '@xrengine/editor/src/systems/ClickPlacementSystem'
import { AssetLoader } from '@xrengine/engine/src/assets/classes/AssetLoader'
import { NO_PROXY, State, getMutableState, getState, useHookstate, useMutableState } from '@xrengine/hyperflux'
