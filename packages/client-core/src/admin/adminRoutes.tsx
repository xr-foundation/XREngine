...
import { ThemeState } from '@xrengine/client-core/src/common/services/ThemeService'
import { getMutableState, getState, NO_PROXY, useHookstate, useMutableState } from '@xrengine/hyperflux'
...
const AdminTopBar = () => {
  ...
  return (
    <div className="flex h-16 w-full items-center justify-between bg-theme-surface-main px-8 py-4">
      <img src="static/xrengine.svg" alt="XREngine Logo" className={`h-7 w-7${theme.value === 'light' ? ' invert' : ''}`} />
